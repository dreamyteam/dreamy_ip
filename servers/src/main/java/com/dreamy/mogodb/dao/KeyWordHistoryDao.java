 ...
 */
@Repository("keyWordHistoryDao")
public class KeyWordHistoryDao extends MongoGenDao<KeyWordHistory> {
    @Override
    protected Class<KeyWordHistory> getEntityClass() {
        return KeyWordHistory.class;
    }

    public void updateInser(KeyWordHistory info) {
    ...
    public List<KeyWordHistory> queryByBookId(Integer bookId){
