 ...
 */
@Component
public class JdBookSourceBaseHandler extends ChubanBookSourceBaseHandler {
    ...
    public Integer getHandlerId() {
        return ChubanBookDataSourceEnums.jd.getSource();
    }
    ...
    public Integer getHotIndex(BookView bookView) {
        ...
        if (bookScore != null) {
            ...
            if (commentNum != null && commentNum > 0) {
                Double tmp = commentNum * ChubanBookHotIndexExchangeEnums.jd.getNum();
                score = tmp.intValue();
            }
        }
    ...
    public Integer getReputationIndex(BookView bookView) {
        ...
        if (bookScore != null) {
            ...
            if (score != null && score > 0.0) {
                Double tmp = score * ChubanBookReputationIndexExchangeEnums.jd.getNum() * bookScore.getCommentNum();
